...
export default function MedicalPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("medical")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your medical practice consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Struggling to attract new patients and retain existing ones? We help medical and dental practices
                  build patient acquisition systems that fill your schedule with quality patients who value your care.
                </p>
              </div>
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Get the patient acquisition system that fills your schedule.
                  </CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Help Medical Practices Attract Quality Patients
              </h2>
              <p
              ...
              >
                Our proven strategies help healthcare professionals build trust and grow their patient base.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Fill your schedule with quality patients who value your expertise and care.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Increase treatment acceptance rates and grow your practice revenue.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Build lasting relationships that generate referrals and repeat visits.
                  </p>
                </CardContent>
              </Card>
