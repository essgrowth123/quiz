  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-[#B02020] hover:bg-[#8B1818] active:bg-[#6B1212] text-white font-bold uppercase tracking-wide transition-all duration-200 ease-in-out hover:shadow-lg active:scale-[0.98] border-0 btn-primary",
      },
      size: {
        default: "h-9 px-4 py-2",
        sm: "h-8 rounded-md px-3 text-xs",
        lg: "h-10 rounded-md px-8",
        xl: "h-12 px-6 py-4 text-base sm:text-lg",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
