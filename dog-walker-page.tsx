...
export default function DogWalkerPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("dog-walker")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your pet service consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Struggling to find reliable, long-term clients who value your pet care services? We help dog walkers
                  and pet service providers build trust, charge premium rates, and create a waiting list of clients.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  "Attract pet owners who pay premium rates",
                  "Build trust and credibility with worried pet parents",
                  "Create recurring revenue with regular clients",
                  "Stand out from cheap, unreliable competitors",
                ].map((benefit, index) => (
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Ready to Build Your Pet Empire?
                  </CardTitle>
                  <CardDescription
                    className="text-lg"
                    style={{
                  ...
                  >
                    Get the client acquisition system that fills your schedule.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className="h-12 text-base border-2 focus:border-yellow-400"
                        placeholder="Enter your pet service business name"
                      />
                    </div>
                    ...
                    >
                      Get My Pet Business Growth Plan
                    </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Help Pet Service Providers Build Thriving Businesses
              </h2>
              <p
              ...
              >
                Our proven strategies help pet professionals build trust and create loyal, long-term clients.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Give pet parents confidence that their furry family is in the best hands.
                  </p>
                </CardContent>
              </Card>
            </div>
