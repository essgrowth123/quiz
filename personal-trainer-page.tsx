...
export default function PersonalTrainerPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("personal-trainer")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your personal training business consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Tired of splitting fees with gyms and competing for floor space? We help personal trainers build
                  independent practices with premium 1-on-1 clients who pay top dollar for transformation.
                </p>
              </div>

              <div className="space-y-4">
                {[
                  "Attract clients who pay $100-200+ per session",
                  "Build your own studio or in-home training business",
                  "Stop splitting fees with gyms and franchises",
                  "Create transformation programs that get results",
                ].map((benefit, index) => (
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Get the system that attracts premium 1-on-1 clients.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className="h-12 text-base border-2 focus:border-yellow-400"
                        placeholder="Enter your training business name"
                      />
                    </div>
                    ...
                    >
                      Get My Personal Training Business Plan
                    </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Help Personal Trainers Build Independent Practices
              </h2>
              <p
              ...
              >
                Our proven strategies help trainers escape gym limitations and build premium client practices.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Attract clients who pay $100-200+ per session for transformation results.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Stop splitting fees with gyms and keep all your earnings.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-4 flex justify-center">
                    <Zap className="w-12 h-12" style={{ color: "#003366" }} />
                  </div>
                  <h3
                    className="text-xl font-bold mb-3"
                    style={{
                  ...
                  >
                    Create transformation programs that deliver life-changing results.
                  </p>
                </CardContent>
              </Card>
            </div>
