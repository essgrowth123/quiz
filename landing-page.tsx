...
import { CheckCircle, TrendingUp, DollarSign, Users, Wrench } from "lucide-react"
...
export default function ESSLandingPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("blue-collar")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your blue-collar business consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Tired of competing on price alone? We help blue-collar business owners learn the exact words and
                  strategies to sell value, build trust, and close more deals at higher prices.
                </p>
              </div>
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Get the sales training that helps you sell value, not just price.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className="h-12 text-base border-2 focus:border-yellow-400"
                        placeholder="e.g., Plumbing, Electrical, HVAC, etc."
                      />
                    </div>
                    ...
                    >
                      Get My Sales Training Blueprint
                    </Button>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Stop competing on price and start selling the value of quality workmanship.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Increase your profit margins by positioning yourself as the premium choice.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Attract customers who value quality work and pay on time.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-4 flex justify-center">
                    <Wrench className="w-12 h-12" style={{ color: "#003366" }} />
                  </div>
                  <h3
                    className="text-xl font-bold mb-3"
                    style={{
                  ...
                  >
                    Present yourself as the expert professional that customers trust.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center mt-12">
              <Button
                ...
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                🚀 Transform Your Blue-Collar Business Today
              </Button>
            </div>
          </div>
        </div>
