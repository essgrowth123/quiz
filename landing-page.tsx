    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white to-gray-50">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your call with the owner...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
        ...
        <footer className="bg-blue-900 text-white py-6 mt-16" style={{ backgroundColor: "#003366" }}>
          <div className="container mx-auto px-4 text-center">
            <p className="text-gray-300" style={{ fontFamily: "Roboto, sans-serif", color: "#666666" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Tired of lost leads and missed appointments? Discover how a simple, automated intake process can
                  transform your business, ensuring no client falls through the cracks.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  "Eliminate manual data entry & human error",
                  "Ensure every lead is captured and followed up",
                  "Impress clients with a professional, seamless experience",
                  "Free up your time and your team's time",
                ].map((benefit, index) => (
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Ready to Systematize Your Sales?
                  </CardTitle>
                  <CardDescription
                    className="text-lg"
                    style={{
                  ...
                  >
                    Enter your details to get started and book your call.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      Get My Free Intake System Overview
                    </Button>
