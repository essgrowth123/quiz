...
import { CheckCircle, TrendingUp, DollarSign, Users, Star } from "lucide-react"
...
export default function CarDetailingPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("car-detailing")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your car detailing business consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Tired of competing with $20 car washes and customers who don't value quality? We help detailing
                  professionals attract luxury car owners who pay premium prices for perfection.
                </p>
              </div>
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Ready to Build Your Premium Detailing Business?
                  </CardTitle>
                  <CardDescription
                    className="text-lg"
                    style={{
                  ...
                  >
                    Get the system that attracts high-end car enthusiasts.
                  </CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Help Detailers Build Premium Businesses
              </h2>
              <p
              ...
              >
                Our proven strategies help detailing professionals attract luxury clients and charge premium rates.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Attract owners of luxury and exotic cars who value perfection.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Charge $500-2000+ for paint correction and ceramic coating services.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Build monthly maintenance packages for consistent income.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-4 flex justify-center">
                    <Star className="w-12 h-12" style={{ color: "#003366" }} />
                  </div>
                  <h3
                    className="text-xl font-bold mb-3"
                    style={{
                  ...
                  >
                    Position yourself as the go-to expert for high-end vehicle care.
                  </p>
                </CardContent>
              </Card>
            </div>
