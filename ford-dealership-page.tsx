...
export default function FordDealershipPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("ford")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your dealership training consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {[
                  "Overcome common sales objections with ease",
                  "Build instant rapport and trust with customers",
                  "Structure compelling sales presentations",
                  "Drive consistent, high-value vehicle sales",
                ].map((benefit, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Transform Dealership Sales Teams
              </h2>
              <p
