...
import { CheckCircle, TrendingUp, DollarSign, Users, Sparkles } from "lucide-react"
...
export default function HomeCleaningPage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("home-cleaning")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your cleaning business consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Tired of competing on price and dealing with one-time cleanings? We help cleaning services build
                  recurring client relationships, charge premium rates, and create a business that runs without you.
                </p>
              </div>

              <div className="space-y-4">
                {[
                  "Convert one-time cleanings into recurring clients",
                  "Charge premium rates for quality service",
              ...
              <div className="pt-4">
                ...
                >
                  🧽 Get Your Cleaning Business Growth System
                </Button>
              </div>
            </div>
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Get the system that turns cleanings into recurring revenue.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      Get My Cleaning Business Growth System
                    </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Help Cleaning Services Build Recurring Revenue
              </h2>
              <p
              ...
              >
                Our proven strategies help cleaning professionals build predictable, scalable businesses.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Turn one-time cleanings into weekly, bi-weekly, and monthly recurring clients.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Stop competing on price and start selling value and reliability.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Build trust and reliability that keeps clients coming back for years.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-4 flex justify-center">
                    <Sparkles className="w-12 h-12" style={{ color: "#003366" }} />
                  </div>
                  <h3
                    className="text-xl font-bold mb-3"
                    style={{
                  ...
                  >
                    Build processes that allow you to grow without being tied to every cleaning.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center mt-12">
              <Button
                ...
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                ✨ Scale Your Cleaning Empire Now
              </Button>
            </div>
          </div>
        </div>
