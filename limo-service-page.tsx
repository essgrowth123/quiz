...
import { CheckCircle, TrendingUp, DollarSign, Users, Car } from "lucide-react"
...
export default function LimoServicePage() {
  ...
  const { trackFormSubmit, trackCalendlyClick, trackFormError } = useConversionTracking("limo")
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "Roboto, sans-serif" }}>
                Redirecting you to Calendly to book your limo service consultation...
              </p>
              <Button
                onClick={() => {
                  trackCalendlyClick()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Is your limo service struggling to fill your fleet? We build custom sales and marketing systems that
                  attract premium clients and keep your cars booked.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  "Attract corporate clients & event planners",
                  "Optimize your online presence for bookings",
                  "Convert website visitors into loyal customers",
                  "Systematize your sales process for consistent growth",
                ].map((benefit, index) => (
            ...
            <div className="lg:pl-8">
              <Card className="shadow-2xl border-0">
                <CardHeader className="text-center pb-6">
                  ...
                  >
                    Tell us about your limo service and your goals.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        type="text"
                        required
                        value={formData.limoService}
                        onChange={handleInputChange}
                        className="h-12 text-base border-2 focus:border-yellow-400"
                        placeholder="Enter your limo service name"
                      />
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                How We Help Limo Services 'Kick Ass' at Sales
              </h2>
              <p
              ...
              >
                Our proven strategies are designed to fill your booking calendar and maximize your fleet's potential.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Drive more high-value clients to your limo service with optimized lead generation.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Convert more inquiries into paid rides with persuasive sales funnels.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  >
                    Build loyalty and repeat business with seamless customer experiences.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-4 flex justify-center">
                    <Car className="w-12 h-12" style={{ color: "#003366" }} />
                  </div>
                  <h3
                    className="text-xl font-bold mb-3"
                    style={{
                  ...
                  >
                    Streamline your intake and booking process for maximum efficiency.
                  </p>
                </CardContent>
              </Card>
            </div>
